...
namespace LicoreriaTom.Controllers
{
    public class ClientesWebController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Codigo,Nombre,Apellido")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Codigo,Nombre,Apellido")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
